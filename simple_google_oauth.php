...
/**
 * Simple Google OAuth Refresh Token Generator
 * Uses a more standard redirect URI approach
 */

echo "🔑 Simple Google OAuth Refresh Token Generator\n";
echo "=============================================\n\n";
...
echo "3. In 'Authorized redirect URIs', add this EXACT URL:\n";
...
if (isset($data['refresh_token'])) {
    ...
    echo "- Redirect URI mismatch (make sure you added the URI above)\n";
}
