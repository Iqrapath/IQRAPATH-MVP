...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p style="margin: 10px 0 0 0; opacity: 0.9;">You have been assigned to teach a new session</p>
        </div>
        
        <div class="content">
            <p>Hello {{ $notifiable->name }},</p>
            
            <p>You have been assigned to teach a new session. Please review the details below:</p>
            ...
            <p>If you have any questions or concerns about this assignment, please contact the administration.</p>
        </div>
