...
<head>
    ...
    <title>Booking Teacher Changed - Important Update</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p style="margin: 10px 0 0 0; opacity: 0.9;">Your session has been reassigned to a different teacher</p>
        </div>
        
        <div class="content">
            <p>Hello {{ $notifiable->name }},</p>
            
            <p>We wanted to inform you that your upcoming session has been reassigned to a different teacher. The session details remain the same:</p>
            ...
            <div class="teacher-change">
                <h3>New Teacher Assignment</h3>
                <p><strong>Your new teacher will be:</strong> {{ $booking->teacher->name }}</p>
                <p>Please prepare for your session as scheduled. Your new teacher will contact you if needed.</p>
            </div>
            ...
            <a href="{{ route('student.dashboard') }}" class="action-button">View Dashboard</a>
        </div>
