...
<body>
    ...
    <div class="content">
        ...
        <p>Here's your wallet activity report for the last 30 days from IQRAQUEST.</p>

        <div class="summary-box">
            <h3 style="margin-top: 0; color: #338078;">Wallet Summary</h3>
            ...
            <div class="summary-item">
                ...
                <span class="summary-value">₦{{ number_format($summary['total_deposited'], 2) }}</span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Total Spent:</span>
                <span class="summary-value">₦{{ number_format($summary['total_spent'], 2) }}</span>
            </div>
            <div class="summary-item">
                <span class="summary-label">Pending Payments:</span>
                <span class="summary-value">₦{{ number_format($summary['pending_payments'], 2) }}</span>
            </div>
        </div>
                ...
                <tbody>
                    @foreach($transactions as $transaction)
                        <tr>
                            ...
                            <td class="{{ in_array($transaction['type'], ['credit', 'deposit', 'refund']) ? 'amount-positive' : 'amount-negative' }}">
                                {{ in_array($transaction['type'], ['credit', 'deposit', 'refund']) ? '+' : '-' }}₦{{ number_format($transaction['amount'], 2) }}
                            </td>
                            <td>
