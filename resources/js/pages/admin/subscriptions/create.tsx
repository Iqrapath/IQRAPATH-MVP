...
export default function CreateSubscriptionPlan({ errors }: Props) {
    ...
    return (
        <AdminLayout pageTitle="Create Subscription Plan">
            ...
            <div className="space-y-6 p-6">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Create a new subscription plan for students</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        >
                            {isConverting ? 'Converting...' : 'Create Plan'}
                        </Button>
                    </div>
                </form>
            </div>
