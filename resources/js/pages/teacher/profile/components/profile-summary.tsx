...
import { MapPin, Star, Camera, X, VerifiedIcon, XCircle } from 'lucide-react';
...
export default function ProfileSummary({ user, profile, reviews }: ProfileSummaryProps) {
                    ...
                    <div className="flex-1 pl-8">
                        <div className="flex justify-between items-start mb-6">
                            ...
                            {profile?.verified ? (
                                ...
                                <div className="bg-red-50 text-red-600 px-3 py-1 rounded-full flex items-center gap-2 text-lg font-medium">
