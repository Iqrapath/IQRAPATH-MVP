...
// Header components
import SearchBar from '../student/teachers/components/SearchBar';
import FiltersBar from '../student/teachers/components/FiltersBar';
...
export default function BrowseTeachers({ teachers, subjects, filters }: BrowseTeachersProps) {
    ...
    const handleSearch = () => {
        router.get('/guardian/browse-teachers', {
            search: searchTerm,
    ...
    return (
        <GuardianLayout pageTitle="Browse Teachers" showRightSidebar={false}>
            ...
            <div className="min-h-screen bg-gray-50 p-4">
                        ...
                        <BreadcrumbList>
                            <BreadcrumbItem>
                                <BreadcrumbLink asChild>
                                    <Link href="/guardian/dashboard">Dashboard</Link>
                                </BreadcrumbLink>
                            </BreadcrumbItem>
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                ...
                {teachers.data.length === 0 && (
                    <div className="text-center py-12 bg-white rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <Button 
                            onClick={() => router.get('/guardian/browse-teachers')}
