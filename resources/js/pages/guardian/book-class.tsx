/**
 * 🎨 FIGMA REFERENCE
 * URL: https://www.figma.com/design/jmWnnfdCipxqiQF39Tdb0S/IQRAQUEST?node-id=397-27039&t=O1w7ozri9pYud8IO-0
 * 
...
export default function BookClassPage({ teacher }: BookClassPageProps) {
    const [selectedDates, setSelectedDates] = useState<Date[]>([]);
    const [selectedAvailabilityIds, setSelectedAvailabilityIds] = useState<number[]>([]);

    if (!teacher) {
        return (
            <GuardianLayout pageTitle="Book Class">
                ...
                <div className="max-w-4xl mx-auto px-6 py-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-base text-gray-600">
                            You're booking a session with {teacher.name} for your child
                        </p>
                    </div>
