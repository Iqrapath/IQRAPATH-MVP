...
const breadcrumbs = [
    ...
    { title: "Add New Student", href: route("guardian.children.create"), className: "text-[#338078]" }
];
...
export default function CreateChild({ availableSubjects }: CreateChildProps) {
    const { data, setData, post, processing, errors } = useForm<CreateChildForm>({
        children: [{
            name: '',
            age: '',
            gender: '',
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route('guardian.children.store'), {
            onSuccess: () => {
    ...
    return (
        <GuardianLayout pageTitle="Add New Student">
