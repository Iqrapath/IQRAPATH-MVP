 ...
 * Export: Teacher profile modal (preview) - Guardian Version
 */
...
import TeacherTabBio from '@/components/common/teacher-tabs/TeacherTabBio';
import TeacherTabCalendar from '@/components/common/teacher-tabs/TeacherTabCalendar';
import TeacherTabPricing from '@/components/common/teacher-tabs/TeacherTabPricing';
import TeacherTabReviews from '@/components/common/teacher-tabs/TeacherTabReviews';
...
function normalizeSubjects(subjects: unknown): string[] {
    if (Array.isArray(subjects)) {
        ...
        return (subjects as { template?: { name: string }; name: string }[])
...
export default function TeacherProfileModal({ teacher, trigger }: TeacherProfileModalProps) {
    ...
    useEffect(() => {
        if (modalOpen && teacher.id) {
            setIsLoading(true);
            fetch(`/guardian/teachers/${teacher.id}/profile-data`)
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-3 pt-4 mb-4">
                        <Button
                            onClick={() => router.visit(`/guardian/book-class?teacherId=${currentTeacher.id}`)}
