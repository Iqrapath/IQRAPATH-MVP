...
export default function SessionDetailsPage({ 
    ...
    if (!teacher_id || !dates || dates.length === 0 || !availability_ids || availability_ids.length === 0) {
        return (
            <GuardianLayout pageTitle="Session Details">
    ...
    const handleGoBack = () => {
        if (previous_page) {
            ...
            router.visit(`/guardian/book-class?teacherId=${teacher_id}`);
        }
    };
    ...
    const handleContinue = () => {
        ...
        router.visit('/guardian/booking/pricing-payment', {
            method: 'post',
            data: {
                teacher_id,
                dates,
                    ...
                    <div >
                        ...
                        <div className="mb-8">
                            <h2 className="text-xl font-semibold text-[#212121] mb-6">
                                Select Subject for Your Child {teacher?.name && (
                        ...
                        <div className="mb-8">
                            ...
                            <textarea
                                ...
                                placeholder="My child wants to focus on Quran memorization and Arabic grammar"
                                rows={4}
