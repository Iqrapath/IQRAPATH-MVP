...
import AddCreditCardModal from '@/components/student/AddCreditCardModal';
...
export default function PaymentMethod({ onPaymentMethodsUpdated }: PaymentMethodProps) {
    ...
    const handleSetDefault = (methodId: number) => {
        ...
        router.patch(`/student/payment-methods/${methodId}/set-default`, {}, {
            preserveScroll: true,
            onSuccess: () => {
                fetchPaymentMethods();
    ...
    const handleConfirmDelete = () => {
        ...
        router.delete(`/student/payment-methods/${methodToDelete}`, {
            preserveScroll: true,
            onSuccess: () => {
                fetchPaymentMethods();
