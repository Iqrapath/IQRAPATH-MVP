...
export default function StudentMessages({ auth, conversations: initialConversations, selectedConversation, messages: initialMessages }: Props) {
    ...
    return (
        <StudentLayout pageTitle="Messages" showRightSidebar={false}>
            <Head title="Messages" />
