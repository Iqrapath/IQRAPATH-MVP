            ...
            <div className="absolute left-0 top-0 w-64 sm:w-72 md:w-80 z-10">
              <div className="relative">
                ...
                <div className="absolute inset-0 pt-12 px-6 flex flex-col">
                  {/* Teacher Cards */}
                  <div>
                    <img src="/assets/images/how-it-works/Frame1.png" alt="Booking Interface" className="w-auto h-auto object-contain" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute right-0 top-[70%] w-64 sm:w-72 md:w-80 z-10">
              <div className="relative">
                ...
                <div className="absolute inset-0 pt-12 px-6 flex flex-col">
                  ...
                  <div>
                    <img src="/assets/images/how-it-works/Frame3.png" alt="Learning Interface" className="w-auto h-auto object-contain" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute left-0 top-0 w-64 sm:w-72 md:w-80 z-10">
              <div className="relative">
                ...
                <div className="absolute inset-0 pt-12 px-6 flex flex-col">
                  {/* Teacher Cards */}
                  <div>
                    <img src="/assets/images/how-it-works/Frame4.png" alt="Booking Interface" className="w-auto h-auto object-contain" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-[35%] w-64 sm:w-72 md:w-80 z-10">
              <div className="relative">
                ...
                <div className="absolute inset-0 pt-12 px-6 flex flex-col">
                  {/* Booking Interface Mockup */}
                  <div>
                    <img src="/assets/images/how-it-works/Frame5.png" alt="Booking Interface" className="w-auto h-auto object-contain" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute right-0 top-[70%] w-64 sm:w-72 md:w-80 z-10">
              <div className="relative">
                ...
                <div className="absolute inset-0 pt-12 px-6 flex flex-col">
                  {/* Learning Interface Mockup */}
                  <div>
                    <img src="/assets/images/how-it-works/Frame6.png" alt="Learning Interface" className="w-auto h-auto object-contain" />
                  </div>
                </div>
              </div>
            </div>
