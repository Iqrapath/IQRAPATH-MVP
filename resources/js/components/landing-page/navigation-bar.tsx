        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center justify-center flex-1 mx-4">
            <div className="flex md:space-x-2 lg:space-x-8">
              ...
              <Link
                href="/find-teacher"
                className="text-[#2F8D8C] hover:text-[#2F8D8C] hover:border-b-2 hover:border-[#2F8D8C] px-2 lg:px-3 py-2 text-sm font-medium whitespace-nowrap"
              >
                Find a Teacher
              </Link>
              <Link
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#FFF9E9] shadow-lg absolute left-0 right-0 top-full z-40 border-t border-gray-100">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              href="/find-teacher"
              className="text-[#2F8D8C] hover:text-[#2F8D8C] block px-3 py-2 text-base font-medium border-l-4 border-transparent hover:border-[#2F8D8C]"
              onClick={() => setMobileMenuOpen(false)}
            >
              Find a Teacher
            </Link>
