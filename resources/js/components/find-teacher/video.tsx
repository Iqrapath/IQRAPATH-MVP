      ...
      {videoUrl ? (
        ...
        <div className="w-full h-full bg-gray-100 flex flex-col items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 14 14">
            <path fill="currentColor" fillRule="evenodd" d="M.183.183a.625.625 0 0 1 .884 0L2.634 1.75h6.241A1.625 1.625 0 0 1 10.5 3.375v.79l1.97-.873c.345-.133.74-.086 1.045.124c.303.21.487.562.485.93v5.307c.002.369-.182.721-.485.931c-.304.21-.7.257-1.045.124l-1.576-.698l2.923 2.923a.625.625 0 1 1-.884.884L.183 1.067a.625.625 0 0 1 0-.884M.625 3.5c.345 0 .625.28.625.625v6.5a.375.375 0 0 0 .375.375h6.5a.625.625 0 1 1 0 1.25h-6.5A1.625 1.625 0 0 1 0 10.625v-6.5C0 3.78.28 3.5.625 3.5" clipRule="evenodd" />
          </svg>
