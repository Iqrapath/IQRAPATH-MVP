...
interface CreditCardIcon {
  className?: string;
  style?: React.CSSProperties;
}

export function CreditCardIcon({ className, style }: CreditCardIcon) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512" className={className} style={style}>
