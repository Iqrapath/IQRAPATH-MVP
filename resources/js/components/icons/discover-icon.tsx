...
export function DiscoverIconProps({ className, style }: DiscoverIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="512" height="86" viewBox="0 0 512 86" className={className} style={style}>
      <defs>
        <linearGradient id="SVG7TDsGd3l" x1="19.414%" x2="88.601%" y1="9.063%" y2="80.499%"><stop offset="0%" stop-color="#f34f26" />
          <stop offset="100%" stop-color="#f69e35" />
        </linearGradient><filter id="SVGhGlqTc4O" width="200%" height="200%" x="-50%" y="-50%" filterUnits="objectBoundingBox">
