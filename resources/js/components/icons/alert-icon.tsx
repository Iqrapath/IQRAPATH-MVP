...
export function AlertIcon({ className, style }: AlertIconProps) {
  return (
	<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 512 512" className={className} style={style}>
