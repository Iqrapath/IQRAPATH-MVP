...
interface AmericanExpressIconProps {
  className?: string;
  style?: React.CSSProperties;
}

export function AmericanExpressIconProps({ className, style }: AmericanExpressIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 256 256" className={className} style={style}>
